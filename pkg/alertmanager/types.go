...
type globalConfig struct {
	...
	SlackAPIURL           *amcommon.URL   `yaml:"slack_api_url,omitempty"`
	SlackAPIURLFile       string          `yaml:"slack_api_url_file,omitempty"`
	PagerdutyURL          *amcommon.URL   `yaml:"pagerduty_url,omitempty"`
	HipchatAPIURL         *amcommon.URL   `yaml:"hipchat_api_url,omitempty"`
	HipchatAuthToken      string          `yaml:"hipchat_auth_token,omitempty"`
	OpsGenieAPIURL        *amcommon.URL   `yaml:"opsgenie_api_url,omitempty"`
	OpsGenieAPIKey        string          `yaml:"opsgenie_api_key,omitempty"`
	OpsGenieAPIKeyFile    string          `yaml:"opsgenie_api_key_file,omitempty"`
	WeChatAPIURL          *amcommon.URL   `yaml:"wechat_api_url,omitempty"`
	WeChatAPISecret       string          `yaml:"wechat_api_secret,omitempty"`
	WeChatAPICorpID       string          `yaml:"wechat_api_corp_id,omitempty"`
	VictorOpsAPIURL       *amcommon.URL   `yaml:"victorops_api_url,omitempty"`
	VictorOpsAPIKey       string          `yaml:"victorops_api_key,omitempty"`
	VictorOpsAPIKeyFile   string          `yaml:"victorops_api_key_file,omitempty"`
	TelegramAPIURL        *amcommon.URL   `yaml:"telegram_api_url,omitempty"`
	WebexAPIURL           *amcommon.URL   `yaml:"webex_api_url,omitempty"`
	JiraAPIURL            *amcommon.URL   `yaml:"jira_api_url,omitempty"`
	RocketChatAPIURL      *amcommon.URL   `yaml:"rocketchat_api_url,omitempty"`
	...
	SlackAppURL           *amcommon.URL   `yaml:"slack_app_url,omitempty"`
}
